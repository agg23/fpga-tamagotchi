...
#52 // LD r, q
TRANSFER IMM_ADDR_L IMM_ADDR_H

// INC X isn't a dedicated instruction

#53 // LDPX r, q
TRANSFER IMM_ADDR_L IMM_ADDR_H INC(XHL)

// INC Y isn't a dedicated instruction

#54 // LDPY r, q
TRANSFER IMM_ADDR_L IMM_ADDR_H INC(YHL)
...
#69 // PUSH r
TRANSFER IMM_ADDR_L MSP_DEC INC(SP_DEC)
...
#78 // POP r
TRANSFER MSP IMM_ADDR_L INC(SP_INC)
