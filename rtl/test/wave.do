...
add wave -noupdate /jp_tb/bench/cpu_uut/memory_addr
add wave -noupdate /jp_tb/bench/cpu_uut/memory_write_data
add wave -noupdate /jp_tb/bench/cpu_uut/memory_read_data
